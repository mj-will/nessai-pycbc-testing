...
--output-file marg_150914_nessai.hdf \
--seed 0 \
--force \
--verbose
...
--input-file marg_150914_nessai.hdf \
--output-file demarg_150914_nessai.hdf \
--nprocesses 1 \
...
--input-file demarg_150914_nessai.hdf \
--output-file demarg_150914_nessai.png \
--parameters \
